...
6. After successful deployment, a "Success" page will appear - click on "Go to Project" to see the project overview and under "Production Deployment", use the first URL as your deployed URL (ends with `deno.dev`)
