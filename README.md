...
2. [Create a New Project](https://dash.deno.com/new_project) on Deno Deploy - click on "Continue with GitHub", select your GitHub user and the forked repository `express-guest-list-api-memory-data-store`
