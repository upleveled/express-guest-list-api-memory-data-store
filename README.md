...
1. On [the fork page for `upleveled/express-guest-list-api-memory-data-store`](https://github.com/upleveled/express-guest-list-api-memory-data-store/fork), select your GitHub account and click "Fork"
2. On [Create a New Project](https://dash.deno.com/new_project), click on "Continue with GitHub" to sign in to Deno Deploy
